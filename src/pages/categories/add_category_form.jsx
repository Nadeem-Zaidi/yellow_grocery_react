      ...
      <div className="relative">
        ...
        <div className="relative rounded-md shadow-sm bg-white">
          ...
          <div className="flex flex-row mt-8">
            <button
              type="submit"
              className=" bg-primary hover:bg-primary-light focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm  text-white w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mx-1 my-1"
            >
              Save
            </button>
            <div
              className="text-white bg-primary hover:bg-primary-light focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mx-1 my-1 cursor-pointer"
              onClick={props.close}
            >
              Close
            </div>
