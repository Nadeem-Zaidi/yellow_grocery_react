    ...
    >
      ...
      <div className="mt-12">
        ...
        {productVariation.length === 0 ? (
          <button
            onClick={() => {
              navigateToProductVariation(product);
            }}
            type="button"
          ...
          <div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {productVariation.map((variation, index) => (
                  <tr
                    key={index}
                    onClick={() =>
                      navigateToUpdateProductVariation(variation.id)
                    }
                  >
            ...
            Another Button
            <button
              onClick={() => navigateToProductVariation(product)}
              type="button"
              className="mt-4 bg-gray-200 rounded-md px-4 py-2"
            >
