...
const SideDrawer = (props) => {
  ...
  return (
    <div
      className={`w-44 bg-white shadow-md h-screen fixed z-50 transition-transform transform ${
        props.toggleDrawer ? "translate-x-0" : "-translate-x-full"
    ...
    >
      ...
      <div className="flex flex-col mt-4">
        <button
          ...
          onClick={() => toggleDropdown(categoriesDropdownRef)}
        >
          <svg
        ...
        <ul ref={categoriesDropdownRef} className="hidden py-2 space-y-2">
          ...
          <li>
            <Link
              to="/attributes"
              onClick={() => handleLinkClick("attribute-list")}
              className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            >
              Attributes
            </Link>
          ...
          <li>
            <Link
              to="/measuringunit"
              onClick={() => handleLinkClick("measuringunit")}
              className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            >
              Measureunit
            </Link>
        ...
        <button
          type="button"
          className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
          onClick={() => toggleDropdown(productsDropdownRef)}
        >
          <svg
            className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
            aria-hidden="true"
